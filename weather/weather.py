...
def get_cpu_temp():
    ...
    tempfile.seek(0)
    raw_temp = tempfile.read().rstrip()

    return float(raw_temp[:-3] + "." + raw_temp[:-3])
...
while True:
    ...
    print("sensor_temp = " + str(sensor_temp), " cpu_temp = " + str(cpu_temp / 5), " temp = " + str(temp)) 
